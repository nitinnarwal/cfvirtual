...
import com.example.cfvirtual.download.data.ReadUtility;
...
public class CodeforcesVirtualRatingCalculator extends CodeforcesRatingCalculator2 {
    ...
    public Contestant generateRating(int contestId, int points, int prevRating){
        List<Contestant> contestantList = ReadUtility.getContestantList(contestId);
        CodeforcesVirtualRatingCalculator calculator = new CodeforcesVirtualRatingCalculator();
        Contestant currentContestant = new Contestant("your_handle", 0, points, prevRating);
        calculator.generateVirtualRating(contestantList, currentContestant);
